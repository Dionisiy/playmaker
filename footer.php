      ...
      <div class="footer-widget">
                        ...
                        <div class="container widget_wrapper">
                            ...
                            <div class="widget widget_recent_entries">
                                ...
                                <ul>
                                    <?php  foreach ($footer_news as $country) : ?>

                                    <li>
                                        <a href="/news/<?php echo $country->slug ?>/"><?php echo $country->name ?></a>
                                    </li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                            <div class="widget widget_categories">
                                ...
                                <ul>
                                  <li>
                                     ...
                                     <li>
                                        <a href="#">Обзоры Бундеслиги</a>
                                    </li>
                                     <li>
                                        <a href="#">Обзоры Ла Лиги</a>
                                    </li>
          ...
          <div class="copyright">
                  <span class="px-section-title">&copy; PLAYMAKER 2018</span>
